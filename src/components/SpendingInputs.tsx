...
import { RotateCcw, Percent, HelpCircle } from "lucide-react";
import { DIVISIONS, SWEDEN_AVERAGE_WEIGHTS } from '@/services/scb';
import { SpendingWeights, getTotalWeight } from '@/utils/weights';
...
const SpendingInputs = ({ weights, onWeightsChange }: SpendingInputsProps) => {
